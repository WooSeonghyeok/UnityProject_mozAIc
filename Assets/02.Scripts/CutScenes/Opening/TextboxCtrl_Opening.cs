...
public class TextboxCtrl_Opening : MonoBehaviour
{
    ...
    public IEnumerator MidVoice()
    {
        ...
        StartCoroutine(_manager.TalkSay(TalkType.player, "뭘, 뭘 찾아야 하는데?", 2f));
        _manager.UserCtrl(true);
    }
    ...
    public IEnumerator EnterLobby()
    {
        ...
        yield return _manager.TalkSay(TalkType.voice, "잊으면 안돼..", 2f, Talker.core, true);
        yield return oneSec;
