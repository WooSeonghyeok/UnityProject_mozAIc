...
public class TextboxCtrl_Ending : MonoBehaviour
{
    ...
    {
        yield return twoSec;
        yield return _manager.TalkSay(TalkType.voice, "괜찮아. 이젠 전부 네 것이니까.", 2f, Talker.self);
        yield return _manager.TalkSay(TalkType.player, "기억은 사라진 게 아니었다.", 2f);
        yield return _manager.TalkSay(TalkType.player, "나는 그것을 견딜 수 있을 만큼 다시 돌아온 거다.", 2f);
    }
